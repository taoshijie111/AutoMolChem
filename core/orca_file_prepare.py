...
def process_conformers(conformer_dir, conformer_type, template_file, output_dir=None, inp_name=None, xyz_name=None, additional_charge=0, additional_multiplicity=0):
    """
...
def main():
    ...
    parser.add_argument(
        '-t', "--conformer_type",
        required=True,
        help="The source of molecular conformations (e.g., omol_opt)"
    )
